...
public class GreenifyComposite implements Composite, CompositeContext {
    ...
    private static int mixPixel(int x) {
        ...
        int xa = (int) (0.2126F * xr + 0.7152F * xg + 0.0722F * xb);

        return (0) | (65280) | (0) | (xa << 24);
    }
    ...
    public static final GreenifyComposite Greenify = new GreenifyComposite();
