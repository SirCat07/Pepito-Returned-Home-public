...
public class MultiplyCompositeForARGB implements Composite, CompositeContext {
    ...
    public static final MultiplyCompositeForARGB Multiply = new MultiplyCompositeForARGB();
